var biblioteca=["javascript", "curso", "computador", "transporte", "livraria", "tecnologia", "controle", "churrasco", "brasil", "monitor", "brinquedo", "youtube", "portaria", "escola", "carnaval", "teclado", "guitarra", "bateria", "chinelo", "helicoptero"];
        ...
        if(jogando){
            ...
            if(!acertou){
                ...
                if(erros<7) {
                    ...
                    document.getElementById("cabeca").src="imagens/cabeca2.jpg"
